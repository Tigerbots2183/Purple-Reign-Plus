...
public class alignpegF extends Command {
  Swerve s_Swerve;
  ...
  public alignpegF(Boolean isrightscore, Swerve s_Swerve) {
 ...
 public void initialize() {
    ...
    if (Targetpose != null) {
        ...
        s_Swerve.drive(new Translation2d(0,0), 0, false,false);
        Command pathfindF = AutoBuilder.pathfindToPose(
            Targetpose,
            constraints,
            0.01
    );
