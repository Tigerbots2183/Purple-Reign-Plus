...
public class alignpegG extends Command {
  Swerve s_Swerve;
  ...
  public alignpegG(Boolean isrightscore, Swerve s_Swerve) {
 ...
 public void initialize() {
    ...
    if (Targetpose != null) {
        ...
        s_Swerve.drive(new Translation2d(0,0), 0, false,false);
        Command pathfindG = AutoBuilder.pathfindToPose(
            Targetpose,
            constraints,
            0.01
    );
